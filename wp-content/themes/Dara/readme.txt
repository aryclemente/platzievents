...
= 4 January 2019 =
* Add resize events and images loaded to slider, to prevent overlap issue in Firefox.

= 1 January 2019 =
* Update CSS work around for flexslider overlap issue in Firefox.
* Use CSS and a temporary class to prop up the flexslider slideshow while the page loads, to fix an overlap issue in Firefox.
...
= 21 November 2018 =
* Correct issue with narrow captions in Chrome.
* Make centred images aligned centred if they're smaller than the available space.
...
= 15 March 2018 =
* Allow for full-width galleries when a footer widget area is active; removes deprecated function to change the gallery width in Jetpack, as these are now handled by core.
